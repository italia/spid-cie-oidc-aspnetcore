...
internal class MockOptionsMonitorSpidCieOptions : IOptionsMonitor<SpidCieOptions>
{
    ...
    {
        return new SpidCieOptions()
        {
            SpidOPs = _emptyCollection
                ? new System.Collections.Generic.List<string>()
                : new System.Collections.Generic.List<string>() { "http://127.0.0.1:8000/oidc/op/" },
            CieOPs = _emptyCollection
                ? new System.Collections.Generic.List<string>()
                : new System.Collections.Generic.List<string>() { "http://127.0.0.1:8002/oidc/op/" },
            RelyingParties = _emptyCollection
                ? new System.Collections.Generic.List<RelyingParty>()
                : new System.Collections.Generic.List<RelyingParty>() {
                    new RelyingParty()
                    {
